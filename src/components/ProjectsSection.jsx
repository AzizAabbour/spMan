...
const PROJECTS = [
  {
    id: '01',
    title: 'AZIZ AABBOUR// PORTFOLIO WEBSITE',
    subtitle: 'A fully responsive portfolio website for a full-stack engineer with dynamic GSAP canvas visualizer.',
    category: 'Portfolio Website',
    tags: ['React 19', 'GSAP', 'Node.js', 'emailJs', 'WebSockets'],
    image: '/project2.jpg',
    github: 'https://github.com/AzizAabbour/ProAlpah2027.git',
    live: 'https://azizaabbour.xo.je/',
  },
  {
    id: '02',
    title: 'Platforme Créolab // Créolab web agency ',
    subtitle: 'The official website of the Créolab Web platform, the best platform for all educational services.',
    category: 'Web Agence',
    tags: ['GSAP 3', 'ScrollTrigger', 'React', 'Tailwind CSS'],
    image: '/project1.jpg',
    github: 'https://github.com/AzizAabbour/CreoLab-Web.com.git',
    live: 'http://creolabweb.site.je/',
  },
];
