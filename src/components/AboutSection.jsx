...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="relative min-h-screen py-24 md:py-36 px-6 md:px-12 bg-[#f8f9fa] border-t border-zinc-200/80 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-start pt-4 lg:pt-0">
            ...
            <div ref={hangingContainerRef} className="relative flex flex-col items-center group cursor-pointer">
              ...
              <div className="w-3 h-3 rounded-full bg-zinc-900 border-2 border-red-600 shadow-md z-20" />

              {/* Long Thin Suspension Thread (Longer on Desktop as required) */}
              <div className="w-[1.5px] h-32 md:h-52 bg-gradient-to-b from-red-600 via-zinc-800 to-red-600/80 shadow-sm relative">
              ...
              <div
                ref={profileFrameRef}
                className="relative w-60 h-60 md:w-72 md:h-72 rounded-full p-2 bg-gradient-to-tr from-zinc-900 via-red-600 to-zinc-900 border-4 border-zinc-900 shadow-2xl transition-transform duration-500 group-hover:scale-[1.03]"
              ...
              >
                ...
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-6 h-6 rounded-full border-2 border-red-600 bg-zinc-900 shadow-md flex items-center justify-center">
              ...
              <div className="mt-6 text-center">
                <span className="text-xs font-mono font-semibold uppercase tracking-widest text-zinc-500 bg-zinc-200/60 px-3 py-1 rounded-full">
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            <div
              ref={eyebrowRef}
              className="inline-flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-widest text-red-600 mb-4"
            >
              {/* Spider Icon SVG */}
              <svg className="w-4 h-4 fill-current text-red-600 animate-bounce" viewBox="0 0 24 24">
            ...
            <div className="overflow-hidden mb-8">
              <h2
                ref={headingRef}
                className="font-syne text-4xl sm:text-5xl md:text-6xl font-extrabold italic uppercase tracking-tight text-zinc-900 leading-tight"
              >
                CRAFTING HIGH-PERFORMANCE <span className="text-red-600">FULL-STACK</span> WEBS.
              </h2>
            </div>

            {/* 3D Paragraph Reveal Container (perspective: 1000px) */}
            <div ref={paragraphContainerRef} className="perspective-1000 space-y-6 text-zinc-700 font-sans text-base md:text-lg leading-relaxed">
              <p
              ...
              <p
                ...
                className="backface-hidden font-medium text-zinc-900 border-l-2 border-red-600 pl-4"
              >
            ...
            <div id="tech-stack" className="mt-12 pt-8 border-t border-zinc-200">
              <h3 className="text-xs font-mono font-bold uppercase tracking-widest text-zinc-500 mb-6">
                ...
                {TECH_STACK.map((tech, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className="group relative inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-white border border-zinc-200 shadow-sm text-zinc-800 text-xs font-semibold uppercase tracking-wider cursor-pointer hover:bg-zinc-900 hover:text-white hover:border-zinc-900 hover:shadow-lg hover:shadow-red-600/10 transition-all duration-300"
                    >
                      <IconComponent className="w-4 h-4 text-red-600 group-hover:text-red-500 transition-colors" />
                      <span>{tech.name}</span>
                      <span className="text-[10px] text-zinc-400 font-mono group-hover:text-zinc-400 ml-1">
                        [{tech.cat}]
                      </span>
                    </div>
                  );
